...
Protected Class GenerateXrechnungApi
	#tag Method, Flags = &h0
		Sub GenerateXrechnungApi(, id As String, Optional supplierName As Xoson.O.OptionalString, Optional supplierStreet As Xoson.O.OptionalString, Optional supplierCity As Xoson.O.OptionalString, Optional supplierZip As Xoson.O.OptionalString, Optional supplierCountry As Xoson.O.OptionalString, Optional supplierVatId As Xoson.O.OptionalString)
		  ...
		  //
		  // Invokes GenerateXrechnungApiCallbackHandler.GenerateXrechnungApiCallback(XRechnungResponse) on completion. 
		  //
		  ...
		  Dim localVarPath As String = "/api/v1/invoices/{id}/xrechnung"
		  ...
		  AddHandler localVarHTTPSocket.PageReceived, addressof me.GenerateXrechnungApi_handler
		  AddHandler localVarHTTPSocket.Error, addressof Me.GenerateXrechnungApi_error
	...
	#tag Method, Flags = &h21
		Private Function GenerateXrechnungApiPrivateFuncDeserializeResponse(HTTPStatus As Integer, Headers As InternetHeaders, error As OpenAPIClient.OpenAPIClientException, Content As String, ByRef outData As OpenAPIClient.Models.XRechnungResponse) As Boolean
		  ...
		  If HTTPStatus > 199 and HTTPStatus < 300 then
		    If contentType.LeftB(16) = "application/json" then
			  ...
			  outData = New OpenAPIClient.Models.XRechnungResponse
			  Try
	...
	#tag Method, Flags = &h21
		Private Sub GenerateXrechnungApi_error(sender As HTTPSecureSocket, Code As Integer)
		  If sender <> nil Then sender.Close()

		  Dim error As New OpenAPIClient.OpenAPIClientException(Code)
		  Dim data As OpenAPIClient.Models.XRechnungResponse
		  CallbackHandler.GenerateXrechnungApiCallback(error, data)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub GenerateXrechnungApi_handler(sender As HTTPSecureSocket, URL As String, HTTPStatus As Integer, Headers As InternetHeaders, Content As String)
		  #Pragma Unused URL
		  ...
		  Dim data As OpenAPIClient.Models.XRechnungResponse
		  Call GenerateXrechnungApiPrivateFuncDeserializeResponse(HTTPStatus, Headers, error, Content, data)
	...
	#tag Property, Flags = &h0
		CallbackHandler As OpenAPIClient.APIs.GenerateXrechnungApiCallbackHandler
	#tag EndProperty
